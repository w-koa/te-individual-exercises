...
public class PlayingCard {
	...
	public static enum CardSuit { // public is OK since they are constants and cannot be changed
		SPADE, CLUB, HEART, DIAMOND, JOKER // static so it can be referenced using the class name. ie. no object
											// required
	};
	 ...
	 * 
	 * protected so subclasses may access is OK since they are constants and cannot
	 * be changed
	 * 
	 * static so it can be referenced using the class name. ie. no object required
	 ***************************************************************************************************/
	...
	public boolean equals(Object otherObject) { // Compare two PlayingCards for equality - note generic Object parameter
		...
		if (otherObject == this) { // if object being compared to itself
			...
			if ((otherObject instanceof PlayingCard)) { // If the object being compared to is the same class as object
				PlayingCard otherCard = (PlayingCard) otherObject; // Define a PlayingCard object from object being
																	// compared to
	...
	public int hashCode() { // Generate hashCode for object if Java needs one - HashCode is a unique value
							// representing an instance of an object
		int hashValue = 17;
