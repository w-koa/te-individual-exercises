...
public class PokerHand extends CardHand {
	...
	public static enum PokerHandRanking { // Hand rankings from low to high
		NOTRANKED, HIGHCARD, PAIR, TWOPAIR, THREEOFAKIND, STRAIGHT, FLUSH, FULLHOUSE, FOUROFAKIND, STRAIGHTFLUSH,
		ROYALSTRAIGHTFLUSH
	};
	 ...
	 * 
	 * Note this is V0 version of the method - it could possibly be refactored to be
	 * better, but it works
	 ****************************************************************************************************/
	public PokerHandRanking rankHand() {
		...
		if (((this.aHand.get(0).getValue() == PlayingCard.CardValue.ONE)
				...
				&& (this.aHand.get(1).getValue() == PlayingCard.CardValue.TEN)) && hasFlush()) {
	 ...
	 * 
	 * Note these are V0 versions of the methods - they could possibly be refactored
	 * to be better, but they work
	 ***************************************************************************************************/
